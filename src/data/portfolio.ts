...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    process: [
      {
        caption:
          "De inspiratie: een echte paua uit Nieuw-Zeeland, gevormd door de natuur, laag op laag.",
        images: ["/images/proces/paua/stap-1.jpg"],
      },
      {
        caption:
          "Losse banden RVS, gebogen en geschikt tot de contour van de schelp.",
        images: ["/images/proces/paua/stap-2.jpg"],
      },
      {
        caption: "Paneel voor paneel aan elkaar gehecht, las voor las.",
        images: ["/images/proces/paua/stap-3.jpg"],
      },
      {
        caption:
          "De geribde zijde krijgt vorm — met de karakteristieke rij ademgaten.",
        images: ["/images/proces/paua/stap-4.jpg"],
      },
      {
        caption:
          "Met de vlam in het RVS gebrand: aanloopkleuren, zoals de oceaan zijn kleuren in de schelp legde.",
        images: ["/images/proces/paua/stap-5.jpg"],
      },
    ],
  },
  {
